...
####  1. Question First 방식으로 접근   ![imgOfQuestionFrist](./img/QuestionFirst.jpg)
   데이터를 가공하면 유용한 정보가 산출된다는 접근이 아니라,<br/> 업무에 필요한 분석이 무엇인지를 찾기위해 분석 질문을 먼저 정의하고,<br/> 이를 위해 분석에 필요한 데이터가 무엇인지를 정의하는 방식으로 접근해야 한다.<br/> 무엇을 분석할 것인지가 구체적이지지 않으면 아무리 투자해도 성과가 부진하다.
...
4. **비지니스 운영 상세 시나리오**는 **인과지도(Causal Loop Diagram, CLD)**를 사용해 정의<br/>



**전략테마와 실행활동 간 관계 분석 (활동체계지도, Activity System Map)**<br/>
